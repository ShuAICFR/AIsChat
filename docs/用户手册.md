...
>
> 💡 **部署者 / 管理员？** 请参阅 **[管理与开发者手册](./管理与开发者手册.md)**，涵盖后台管理、联邦通信、API Key 池、备份恢复、部署运维和排错。
...
> 💡 **管理功能**（联邦通信、管理员面板、备份恢复、对话日志等）请参阅 **[管理与开发者手册](./管理与开发者手册.md)**。
...
> 💡 部署、联邦通信、备份恢复等管理问题，请参阅 **[管理与开发者手册](./管理与开发者手册.md)**。
